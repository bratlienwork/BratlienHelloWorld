...
public class TestCase1 extends TestCase {
  ...
  public void setUp() throws Exception {
		System.setProperty("webdriver.chrome.driver", "C:\\Tricentis\\chromedriver.exe");
  ...
  public void test() throws Exception {
		click(null, By.id("nav_camper"), MOUSE_LEFT, 1);
		selectItemByVisibleText(null, By.id("make"), 4, "– please select –" );
		selectItemByVisibleText(null, By.id("make"), 2, "Audi" );
		sendKeys(null, By.id("engineperformance"), "250", true, 4);
		sendKeys(null, By.id("dateofmanufacture"), "12/1/2018", true, 6);
		selectItemByVisibleText(null, By.id("numberofseats"), 9, "– please select –" );
		selectItemByVisibleText(null, By.id("numberofseats"), 2, "3" );
		click(null, By.xpath(".//*[@id='insurance-form']/div/section[1]"), MOUSE_LEFT, 2);
  }
